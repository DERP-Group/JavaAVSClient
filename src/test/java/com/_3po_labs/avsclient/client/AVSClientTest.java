...
import com._3po_labs.avsclient.client.AVSClient;
...
public class AVSClientTest {
	...
	private String uri = "https://dl.dropbox.com/s/jvpy7e8aj02xjlh/AstroBot.wav?dl=1";
	
	@Test
	public void testAVSClient(){
		AVSClient client = new AVSClient();
		Response response = client.recognizeSpeech(accessToken, new RecognizeSpeechRequest(), uri);
	}
}
